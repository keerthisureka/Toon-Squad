      ...
      <div className="flex items-center h-full justify-between">
        ...
        <div className="flex items-center gap-4 md:gap-7">
          ...
          <div className="text-white cursor-pointer" onClick={handleShowMenu}>
            ...
            {showMenu && (
              <div className="absolute right-2 bg-white py-2 px-3 shadow drop-shadow-md rounded flex flex-col">
                <Link to={"signup"} className="whitespace-nowrap text-black">Sign Up</Link>
                <Link to={"login"} className="whitespace-nowrap text-black">Login</Link>
              </div>
            )}
          </div>
        </div>
